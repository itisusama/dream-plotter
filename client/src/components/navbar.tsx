...
const Logo = () => {
  return (
    <Link to="/"><img src="/logo.png" alt="logo" className='w-6 h-6' /></Link>
  );
};
...
const defaultNavigationLinks: NavbarNavLink[] = [
  { href: '#Character', label: 'Character' , active: true  },
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-6">
              ...
              >
                ...
                <Link to="/"><span className="hidden font-bold text-xl sm:inline-block">Dream Plotter</span></Link>
              </button>
              {/* Navigation menu */}
              {!isMobile && (
